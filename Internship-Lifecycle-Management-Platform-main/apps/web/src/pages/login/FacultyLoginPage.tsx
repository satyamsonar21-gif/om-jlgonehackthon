...
import { ArrowLeft, BookOpen, Sparkles, Check } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex bg-[#0A192F] text-white overflow-hidden">
      ...
      <div className="hidden lg:flex w-[55%] flex-col justify-between p-12 bg-[#0A192F] border-r border-white/10 relative overflow-hidden">
        ...
        <div className="z-10 flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-xs uppercase tracking-widest ml-2 text-blue-300 font-mono font-semibold">Faculty Guide</span>
          </div>
        </div>
        ...
        <div className="z-10 max-w-xl my-auto py-6">
          <div className="mb-4 inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 text-blue-200 border border-white/20 text-xs font-mono font-semibold">
            <Sparkles size={12} />
            Academic Observatory & Telemetry
          </div>
          ...
          >
            Academic rigor meets real-time industry supervision.
          </motion.h1>
          <p className="text-sm text-slate-300 font-medium tracking-wide mb-8">
            SUPERVISE. EVALUATE. INTERVENE. CERTIFY.
          </p>

          <div className="p-6 rounded-2xl bg-white/5 border border-white/10 space-y-3">
            <span className="text-xs font-mono font-bold text-blue-300 uppercase tracking-wider block">Guide Telemetry</span>
            <p className="text-xs text-slate-300 leading-relaxed">
              Evaluate weekly synthesis reports, monitor cohort attendance, and provide early intervention recommendations for at-risk undergraduate students.
            </p>
          </div>
        </div>

        <div className="z-10 flex items-center justify-between text-xs text-slate-400 pt-4 border-t border-white/10 font-mono">
          <span>Faculty Observatory Portal</span>
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center items-center p-8 lg:p-16 relative bg-white text-[#0A192F]">
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            <h2 className="text-2xl lg:text-3xl font-bold tracking-tight text-[#0A192F]">Faculty Sign In</h2>
            <p className="text-xs text-slate-500 mt-1">Supervise your assigned undergraduate cohort</p>
          </div>

          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); navigate('/faculty'); }}>
            <div className="space-y-1.5">
              <label className="text-xs font-mono font-semibold uppercase tracking-wider text-slate-700 block">Faculty Email / University ID</label>
              <input 
                type="text" 
